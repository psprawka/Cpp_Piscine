...
/*   Updated: 2018/07/01 20:18:22 by psprawka         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ABullet::ABullet(ABullet const &obj)
{
	*this = obj; 
}

ABullet	&ABullet::operator=(ABullet const &obj)
{
	this->_x = obj.getX();
	this->_y = obj.getY();
	this->_speed = obj.getSpeed();
	this->_represent = obj.getRepresent();
	this->_dir = obj.getDir();
	return (*this);
}

int 	ABullet::getSpeed() const { return this->_speed; }
int 	ABullet::getX() const { return this->_x; }
int 	ABullet::getY() const { return this->_y; }
int 	ABullet::getDir() const { return this->_dir; }
int 	ABullet::getRepresent() const { return this->_represent; }
